...
export declare class ProductGroupService {
    ...
    create(createProductGroupDto: CreateProductGroupDto, userId: string): Promise<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    update(id: string, updateProductGroupDto: UpdateProductGroupDto, userId: string): Promise<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
